...
{
    public float runSpd;
    public static float tiltAng = 12;
    float drag;
    ...
    private void FixedUpdate() {
        ...
        tilt.localRotation = Quaternion.Lerp(tilt.localRotation, Quaternion.AngleAxis(Input.GetAxisRaw("Tilting")*fpsMove.tiltAng, Vector3.forward), 0.2f);
